...
trainedBrain =
  ( ( ($$(fLit (0.57421875)) :> $$(fLit (0.828125)) :> $$(fLit (0.79296875)) :> Nil)
    , ($$(fLit (0.37890625)) :> $$(fLit (0.2109375)) :> $$(fLit (0.3046875)) :> $$(fLit (7.8125e-2)) :> Nil)
      :> ($$(fLit (-0.828125)) :> $$(fLit (0.0)) :> $$(fLit (-0.828125)) :> $$(fLit (0.0)) :> Nil)
      :> ($$(fLit (3.515625e-2)) :> $$(fLit (-0.83984375)) :> $$(fLit (7.8125e-3)) :> $$(fLit (-0.83984375)) :> Nil)
      :> Nil
    )
  , ( ($$(fLit (1.0)) :> $$(fLit (0.99609375)) :> Nil)
    , ($$(fLit (0.0)) :> $$(fLit (-1.20703125)) :> $$(fLit (0.0)) :> Nil)
      :> ($$(fLit (3.90625e-3)) :> $$(fLit (0.0)) :> $$(fLit (-1.2578125)) :> Nil)
      :> Nil
    )
  )

topEntity :: Vec 4 Weight -> Vec 2 Weight
topEntity = SwitchBrain.forward trainedBrain
