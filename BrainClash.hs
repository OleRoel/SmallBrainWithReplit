...
trainedBrain =
  ( ( ($$(fLit (1.0078125)) :> $$(fLit (1.0078125)) :> $$(fLit (1.01171875)) :> Nil)
    , ($$(fLit (0.0)) :> $$(fLit (1.953125e-2)) :> $$(fLit (7.8125e-3)) :> $$(fLit (2.734375e-2)) :> Nil)
      :> ($$(fLit (3.90625e-3)) :> $$(fLit (1.5625e-2)) :> $$(fLit (3.125e-2)) :> $$(fLit (3.125e-2)) :> Nil)
      :> ($$(fLit (-3.90625e-3)) :> $$(fLit (3.90625e-3)) :> $$(fLit (3.515625e-2)) :> $$(fLit (3.515625e-2)) :> Nil)
      :> Nil
    )
  , ( ($$(fLit (1.0)) :> $$(fLit (0.8671875)) :> Nil)
    , ($$(fLit (-3.90625e-3)) :> $$(fLit (7.8125e-3)) :> $$(fLit (0.0)) :> Nil)
      :> ($$(fLit (-0.12109375)) :> $$(fLit (-0.1484375)) :> $$(fLit (-0.15234375)) :> Nil)
      :> Nil
    )
  )
